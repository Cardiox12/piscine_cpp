...
/*   Updated: 2021/01/13 19:58:40 by bbellavi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static const std::vector<std::string> g_death_quotes = {
	"NOOO!",
	"Poop.",
...
static const std::vector<std::string> g_born_quotes {
	"I'm getting alive Yeee-hay!",
	"Does this mean I can start dancing? Pleeeeeeaaaaase?"
};

static const std::vector<std::string> g_vaultexe_activated_quotes = {
...
static const std::vector<std::string> g_critical_hit_quotes {
	"Pop pop!",
	"Crit-i-cal!",
...
static const std::vector<std::string> g_melee_quotes {
...
static const std::vector<std::vector<std::string>> g_all_quotes {
	g_death_quotes,
	g_born_quotes,
